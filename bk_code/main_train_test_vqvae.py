...
parser.add_argument('--arch',       type=str,   default='vqvae',  help='network type: vaeIdsia, vaeIdsiaStn')
...
def test(e, best_acc):
  ...
  class_template = class_template.cuda(async=True)
  with torch.no_grad():
    _, class_recon, _, class_z1, class_z2 = net(class_template)
