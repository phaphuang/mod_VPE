...
parser.add_argument('--arch',       type=str,   default='vaeCatTranDis',
                    help='network type: vaeIdsia, vaeIdsiaStn, vaeTranDis, vaeCatTranDis')
...
tr_loader = data_loader(data_path, args.exp, is_transform=True, split='train', img_size=(
    args.img_rows, args.img_cols), augmentations=data_aug_tr)
