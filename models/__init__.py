...
def get_model(name, n_style, style_out_channel):
    ...
    if name is 'vaeTranDis':
        model = model(nc=3, input_size = 64, latent_variable_size=300, cnn_chn=[100, 150, 250] ,param1=[200,300,200], param2=None, param3 = [150, 150, 150], n_style=n_style, style_out_channel=style_out_channel,attention=True, n_res_blocks=8) # idsianet cnn_chn=[100,150,250] latent = 300
        #model = model(nc=3, input_size = 64, latent_variable_size=300, cnn_chn=[100, 150, 250] ,param1=None, param2=None, param3 =None, n_style=n_style, style_out_channel=style_out_channel,attention=True, n_res_blocks=8) # idsianet cnn_chn=[100,150,250] latent = 300
